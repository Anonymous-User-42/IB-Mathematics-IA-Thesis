...
\textit{Using the materials specified in chapter \ref{mat}, arrange the components as specified in figure \ref{exp1}}

\textit{Following which, according to the \textbf{specified initial conditions} specified in the next chapter carefully oscillate the pendulum.}
